# New software installed: ORCA version 6.1.1

- Source: https://hpc-community.unige.ch/t/4348

- Created: 2026-07-16T09:50:13.289Z
...
## Post 1 by @Gael.Rossignol (2026-07-16T09:50:13.350Z)

Dear users, we have installed a new software: `ORCA 6.1.1`:
```
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    You will need to load all module(s) on any one of the lines below before the "ORCA/6.1.1-avx2" module is available to load.
