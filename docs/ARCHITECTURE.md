...
#    (skips with exit 0 if already merged; --force re-merges through the coverage gate)
./3_submit_merge.sh Stephenson
./3_submit_merge.sh Stephenson --force
```
