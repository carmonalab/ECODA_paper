...
``` bash
rsync -rltvkz --no-p --no-g --progress "[REDACTED_PATH]/Jimenez-Gracia_2026_41526507/output/" "/srv/smednas515.unige.ch/carmona_smb/DataCollections/Standardized_SingleCell_Datasets/Jimenez-Gracia_2026_41526507/output/"
```
