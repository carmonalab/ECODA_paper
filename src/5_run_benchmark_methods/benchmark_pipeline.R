...
# CT column has multiple pending HVGs).
...
# Defaults mirror the former notebook composition settings (factors_test,
# seurat_res, ECODA_top_varexp_hvct). One worker process per dataset;
# set.seed(123) at driver start -> deterministic across HPC re-runs. NOTE:
