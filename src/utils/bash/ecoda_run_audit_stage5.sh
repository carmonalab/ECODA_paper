#!/bin/bash
# Stage 5 recovery, root, method, and artifact audit policy.
# Source after ecoda_run_common.sh and the shared audit helpers.
...
_audit_selected_artifacts() {
  ...
  _ecoda_stage5_expand_output_selection "${scope_selection}" || {
