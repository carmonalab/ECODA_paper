...
SCRIPT_RELATIVE="src/2_dataset_specific_preprocessing/1.2_submit_combinedpbmc.sh"
...
"${PYTHON_BIN}" "${SOURCE_ROOT}/src/2_dataset_specific_preprocessing/1.2.1_create_combinedpbmc_dataset.py"
