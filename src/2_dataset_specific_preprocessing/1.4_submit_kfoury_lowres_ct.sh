...
SCRIPT_RELATIVE="src/2_dataset_specific_preprocessing/1.4_submit_kfoury_lowres_ct.sh"
...
${PIXI_RSCRIPT} "${SOURCE_ROOT}/src/2_dataset_specific_preprocessing/1.4.1_create_kfoury_lowres_ct.R" "$@"
