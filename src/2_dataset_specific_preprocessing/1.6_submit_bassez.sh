...
SCRIPT_RELATIVE="src/2_dataset_specific_preprocessing/1.6_submit_bassez.sh"
...
${PIXI_RSCRIPT} "${SOURCE_ROOT}/src/2_dataset_specific_preprocessing/1.6.1_fill_bassez_cellsubtype.R" "$@"
