...
SCRIPT_RELATIVE="src/2_dataset_specific_preprocessing/1.3_submit_joanito.sh"
...
${PIXI_RSCRIPT} "${SOURCE_ROOT}/src/2_dataset_specific_preprocessing/1.3.1_prepare_joanito.R"
