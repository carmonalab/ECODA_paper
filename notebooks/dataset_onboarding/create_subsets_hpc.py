...
DATASET_CATALOG = [
    ...
    },
    {
        ...
        "bio_col_hint": "condition",
        "batch_cols_hint": ["batch", "sample_prep"],
        "ct_col_hint": "cell_type",
    },
    {
        "name": "Covid19_PBMC",
        ...
        "sample_col_hint": "sample_new",
        "bio_col_hint": "disease_stage",
        "batch_cols_hint": ["batch", "hospital"],
        "ct_col_hint": "cell_type_major",
    },
    {
        "name": "Diabetes",
        "key": "diabetes",
        ...
        "sample_col_hint": "file_id",
        "bio_col_hint": "disease",
        "batch_cols_hint": ["study", "batch"],
        "ct_col_hint": "cell_type",
    },
    {
        "name": "Kidney_KPMP",
        ...
        "bio_col_hint": "disease",
        "batch_cols_hint": ["site", "batch"],
        "ct_col_hint": "subclass.l2",
    },
    {
        "name": "Lupus_PBMC",
        "key": "lupus",
        ...
        "sample_col_hint": "ind_cov",
        "bio_col_hint": "Status",
        "batch_cols_hint": ["batch_cov", "processing_site"],
        "ct_col_hint": "cg_cov",
    },
    {
        "name": "Lung",
        ...
        "sample_col_hint": "sample",
        "bio_col_hint": "disease",
        "batch_cols_hint": ["study", "dataset", "assay"],
        "ct_col_hint": "cell_type",
    },
    {
        ...
        "sample_col_hint": "donor",
        "bio_col_hint": "condition",
        "batch_cols_hint": ["region", "batch"],
        "ct_col_hint": "cell_type",
    },
    {
        "name": "Parkinson",
