...
```json
  "Alzheimer": {
    ...
    "meta_cols_keep": [
      "donor_id", "Cognitive status", "disease", "Class",
      "Subclass", "Supertype", "assay", "PMI", "Brain_region", "APOE4 status"
    ],
    "views": {
      "benchmark_analysis": {
  ...
  "Breast_cancer": {
    ...
    "meta_cols_keep": [
      "donor_id", "sample_id", "disease", "broad_cell_type", "cell_type",
      "author_cell_type", "sequencing_platform", "sample_preservation_method", "suspension_dissociation_time"
    ],
    "views": {
      "benchmark_analysis": {
  ...
  "Covid19_PBMC": {
    ...
    "meta_cols_keep": [
      "sampleID", "PatientID", "CoVID-19 severity", "majorType", "celltype",
      "Single cell sequencing platform", "datasets", "City", "Sample type"
    ],
    "views": {
      "benchmark_analysis": {
  ...
  "Diabetes": {
    ...
    "meta_cols_keep": [
      "dataset__design__sample", "donor_id", "disease", "cell_type",
      "cell_type_reannotatedIntegrated", "dataset", "design", "assay", "diet", "stage"
    ],
    "views": {
      "benchmark_analysis": {
  ...
  "Kidney_KPMP": {
    ...
    "meta_cols_keep": [
      "specimen", "donor_id", "condition.l1", "condition.l2", "subclass.l1",
      "subclass.l2", "subclass.l3", "subclass.full", "major_cell_types", "library", "region.l1", "sample_tissue_type"
    ],
    "views": {
      "benchmark_analysis": {
  ...
  "Lupus_PBMC": {
    ...
    "meta_cols_keep": [
      "sampleID", "ind_cov", "Status", "SLE_status", "cell_types", "ct_cov", "batch_cov", "Processing_Cohort"
    ],
    "views": {
      "benchmark_analysis": {
  ...
  "Lung": {
    ...
    "meta_cols_keep": [
      "sample", "donor_id", "disease", "origin", "origin_fine", "ann_coarse",
      "cell_type_major", "cell_type", "ann_fine", "dataset", "study", "platform", "assay"
    ],
    "views": {
      "benchmark_analysis": {
  ...
  "Myocardial_infarction": {
    ...
    "meta_cols_keep": [
      "patient", "patient_region_id", "patient_group", "sampleType",
      "cell_type", "cell_subtype", "cell_subtype2", "batch"
    ],
    "views": {
      "benchmark_analysis": {
  ...
  "Parkinson": {
    ...
    "meta_cols_keep": [
      "donor_id", "disease", "tissue", "cell_type", "derived_class2",
      "Brain_bank", "assay", "PMI", "RIN", "path_braak_lb"
    ],
    "views": {
      "benchmark_analysis": {
